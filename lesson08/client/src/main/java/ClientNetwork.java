...
public class ClientNetwork {
    ...
    private Callback<String> callOnClose;
                ...
                try {
                    while (!isAuthorized && goOn) { // цикл авторизации
                        ...
                        if (message.startsWith("/authok")) { // если от сервера пришло сообщение,
                            ...
                            goOn = false;
                        } else if (message.equalsIgnoreCase("/error timeout")) { //если долго думали
                            callOnClose.callback("Your time is out");
                            goOn = false;
    ...
    public void setCallOnClose(Callback<String> callOnClose) { this.callOnClose = callOnClose; }
}